...
<ReportSchemaTransform gstVersion="31405" schemaRootName="report_all_orders_notordered" version="1.0" schemaFileName="05_Schema_Transformation.rdd">
    ...
    <Aggregations>
        <Aggregation expression="orderline.orders.totalprice" path="/Reports/Report/orderline.orders.orderid/orderline.orders.userid/OnEveryRow" name="orderline.orders.totalprice" rule="Sum">
            <input-variable xmlns="http://www.4js.com/2004/RTL" name="orderline.orders.totalprice" type="FGLNumeric"/>
        </Aggregation>
        <Aggregation expression="orderline.orders.totalprice" path="/Reports/Report2/OnEveryRow2" name="orderline.orders.totalprice2" rule="Sum">
            <input-variable xmlns="http://www.4js.com/2004/RTL" name="orderline.orders.totalprice" type="FGLNumeric"/>
        </Aggregation>
    </Aggregations>
